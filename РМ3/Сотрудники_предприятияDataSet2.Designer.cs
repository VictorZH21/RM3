...
namespace РМ3 {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("Сотрудники_предприятияDataSet2")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class Сотрудники_предприятияDataSet2 : global::System.Data.DataSet {
        ...
        public Сотрудники_предприятияDataSet2() {
            this.BeginInit();
            this.InitClass();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        protected Сотрудники_предприятияDataSet2(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            Сотрудники_предприятияDataSet2 cln = ((Сотрудники_предприятияDataSet2)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "Сотрудники_предприятияDataSet2";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Сотрудники_предприятияDataSet2.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            Сотрудники_предприятияDataSet2 ds = new Сотрудники_предприятияDataSet2();
        ...
        public partial class ДолжностьDataTable : global::System.Data.TypedTableBase<ДолжностьRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ДолжностьRow AddДолжностьRow(int ID, string Название_должности) {
...
namespace РМ3.Сотрудники_предприятияDataSet2TableAdapters {
    ...
    public partial class ДолжностьTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Должность] WHERE (([ID] = @Original_ID) AND ((@IsNull_Название" +
                "_должности = 1 AND [Название_должности] IS NULL) OR ([Название_должности] = @Ori" +
                "ginal_Название_должности)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Должность] ([ID], [Название_должности]) VALUES (@ID, @Название" +
                "_должности);\r\nSELECT ID, Название_должности FROM Должность WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Должность] SET [ID] = @ID, [Название_должности] = @Название_должности WHERE (([ID] = @Original_ID) AND ((@IsNull_Название_должности = 1 AND [Название_должности] IS NULL) OR ([Название_должности] = @Original_Название_должности)));
SELECT ID, Название_должности FROM Должность WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Название_должности FROM dbo.Должность";
        ...
        public virtual int Fill(Сотрудники_предприятияDataSet2.ДолжностьDataTable dataTable) {
        ...
        public virtual Сотрудники_предприятияDataSet2.ДолжностьDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Сотрудники_предприятияDataSet2.ДолжностьDataTable dataTable = new Сотрудники_предприятияDataSet2.ДолжностьDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Сотрудники_предприятияDataSet2.ДолжностьDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Сотрудники_предприятияDataSet2 dataSet) {
        ...
        public virtual int Delete(int Original_ID, string Original_Название_должности) {
        ...
        public virtual int Insert(int ID, string Название_должности) {
        ...
        public virtual int Update(int ID, string Название_должности, int Original_ID, string Original_Название_должности) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Название_должности, int Original_ID, string Original_Название_должности) {
            return this.Update(Original_ID, Название_должности, Original_ID, Original_Название_должности);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateUpdatedRows(Сотрудники_предприятияDataSet2 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._должностьTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateInsertedRows(Сотрудники_предприятияDataSet2 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._должностьTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        private int UpdateDeletedRows(Сотрудники_предприятияDataSet2 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._должностьTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        public virtual int UpdateAll(Сотрудники_предприятияDataSet2 dataSet) {
            if ((dataSet == null)) {
