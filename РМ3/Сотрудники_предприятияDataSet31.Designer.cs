...
namespace РМ3 {
    ...
    public partial class Сотрудники_предприятияDataSet3 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Сотрудники_предприятияDataSet31.xsd";
        ...
        public partial class ПолDataTable : global::System.Data.TypedTableBase<ПолRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ПолRow AddПолRow(int ID, string Название) {
        ...
        public partial class ПолRow : global::System.Data.DataRow {
            ...
            public string Название {
                get {
                    try {
                        return ((string)(this[this.tableПол.НазваниеColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Название\' в таблице \'Пол\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableПол.НазваниеColumn] = value;
                }
            }
            ...
            public bool IsНазваниеNull() {
                return this.IsNull(this.tableПол.НазваниеColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetНазваниеNull() {
                this[this.tableПол.НазваниеColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace РМ3.Сотрудники_предприятияDataSet3TableAdapters {
    ...
    public partial class ПолTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Пол] WHERE (([ID] = @Original_ID) AND ((@IsNull_Название = 1 A" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Пол] ([ID], [Название]) VALUES (@ID, @Название);\r\nSELECT ID, Н" +
                "азвание FROM Пол WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Пол] SET [ID] = @ID, [Название] = @Название WHERE (([ID] = @Origina" +
                "l_ID) AND ((@IsNull_Название = 1 AND [Название] IS NULL) OR ([Название] = @Origi" +
                "nal_Название)));\r\nSELECT ID, Название FROM Пол WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Название FROM dbo.Пол";
        ...
        public virtual int Fill(Сотрудники_предприятияDataSet3.ПолDataTable dataTable) {
        ...
        public virtual Сотрудники_предприятияDataSet3.ПолDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Сотрудники_предприятияDataSet3.ПолDataTable dataTable = new Сотрудники_предприятияDataSet3.ПолDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Сотрудники_предприятияDataSet3.ПолDataTable dataTable) {
